...
controls = [
    ...
    dbc.Button(
        "Detect Frame", id="detect-frame", n_clicks=0, color="primary", className="d-grid gap-2 col-12 mx-auto"

    ),
    html.A(
        dbc.Button("Download", n_clicks=0, color="info", outline=True, className="d-grid gap-2 col-12 mx-auto"),
